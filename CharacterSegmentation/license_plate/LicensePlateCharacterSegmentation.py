...
def detectCharacterCandidates_LoG(image, reg, SHOW=0):
    # apply a 4-point transform to extract the license plate
    plate = perspective.four_point_transform(image, reg)
    plate = imutils.resize(plate, width=400)
...
if __name__ == "__main__":
    ...
    for img, reg in zip(imageIDs_lateral, regionsImCropped_lateral):
        image_path = os.path.join(script_dir, "../../cropped_real_plates/Lateral", img+"_MLPlate0.png")
